					...
					<form action="{{$module_url_path}}/update/{{ $enc_id or '' }}" id="frm_blogs_page" name="frm_blogs_page" class="form-horizontal cmxform" method="post" enctype="multipart/form-data">
						...
						<div class="form-group last">
                            ...
                            <div class="col-md-9">
                                ...
                                @php $is_image_required = $prev_image_url = ""; @endphp
                                    <div class="fileupload-new thumbnail " style="width: 200px; height: 150px;">
                                    @if(isset($arr_data['image']) && !empty($arr_data['image']) && File::exists($blog_image_base_path.$arr_data['image']))
                                            <img src="{{$blog_image_public_path.$arr_data['image']}}">
                                         @php 
                                            $prev_image_url = $blog_image_public_path.$arr_data['image']; 
                                    ...
                                    <div>
                                           ...
                                           <input type="file" data-validation-allowing="jpg, png, gif" class="default file-input news-image validate-image" name="image" id="image"  class="">
                                           <input type="hidden" name="oldimage" id="oldimage" value="{{ $arr_data['image']  or ''}}"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" id="title" name="title"  data-rule-required="true" class="form-control" value="{{ $arr_data['title'] or 'NA' }}" >
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" id="short_description"  name="short_description"  data-rule-required="true"  class="form-control " value="{{ $arr_data['short_description'] or 'NA' }}">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea  name="description" id="description" class="form-control" data-rule-required="true" rows="15" tabindex="1">{{ $arr_data['description'] or 'NA' }}</textarea>
