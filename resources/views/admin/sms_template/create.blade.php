		...
		<div class="col-md-12">
			...
			<div class="panel ">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal cmxform" id="frm_create_sms_template" name="frm_create_sms_template" action="{{$module_url_path}}/store" method="post">
						{{csrf_field()}}
						<div class="row">
							<div class="col-lg-8">
								<div class="form-group">
									...
									<div class="col-sm-8 col-md-8 col-lg-9">
										<input type="text" name="template_name" value="" id="template_name" class="form-control" placeholder="Template Name" data-rule-required="true"  data-rule-maxlength="60" value="">
						...
						<div class="form-group text-right">
							<div class="col-lg-8">
								<button type="submit" class="btn btn-primary" id="btn_update_email_template">Add</button>
