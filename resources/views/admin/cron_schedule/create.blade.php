						...
						<div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="control-label col-sm-4 col-md-4 col-lg-3" >Event Date<!-- <i class="red">*</i> --></label>
                                    <div class="col-sm-8 col-md-8 col-lg-9">
                                    <div class="input-group">
                                        <!-- <span class="input-group-addon"><i class="ti-user"></i></span> -->
                                        <input type="text" id="datepicker_one" readonly="" value="{{old('event_date')}}" name="event_date" class="form-control" placeholder="Event Date">
                                    </div>
                                </div>
                                </div>
                            </div>							
