...
<script type="text/javascript">
    ...
    */
    var oTable = $('#hidden-table-info').DataTable({
        ...
        {data : 'event_date',"orderable":false,"searchable":true,name:'event_date'},
        {data : 'template_id',"orderable":false,"searchable":false,name:'template_id'},
        {data : 'sent_to',"orderable":false,"searchable":true,name:'sent_to'},
        {data : 'group_id',"orderable":false,"searchable":true,name:'group_id'},
