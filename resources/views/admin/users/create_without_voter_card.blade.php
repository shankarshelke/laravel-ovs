				...
				<div class="panel-body " >
                    ...
                    <br>
						{{-- <div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="aadhar_id" name="aadhar_id" value="{{old('aadhar_id')}}" data-rule-required="true"  
								 class="form-control" data-type="adhaar-number" maxlength="14">
								<span class="error" style="color: red;">{{ $errors->first('aadhar_id') }} </span>
							</div> --}}
							{{-- <label class="col-sm-3 col-sm-2 control-label">Voter Id<i style="color:red;">*</i></label>
							<div class="col-sm-3">
