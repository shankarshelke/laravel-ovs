                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-sm-12 col-md-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="ti-user"></i></span>
                                    <input  name="address" id="address" class="form-control"  placeholder="Address" data-rule-required="true" value="{{old('address')}}" >
                                    <span class="error" style="color: red;">{{ $errors->first('address') }} </span>
                                </div>
                            </div>
                        </div> --}}
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="form-group">                            
                            ...
                            <button class="btn btn-primary" type="submit"  id="btn_add_front_page" onclick="validate();">Create</button>
                        </div>                      
                    </form>
                </div>
            </section>
