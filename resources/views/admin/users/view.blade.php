                            ...
                            <table class="table table-bordered  table-hover">
                                ...
                                <tbody>
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td style="width: 60%;"> <div class="profile-pic ">
                                    @if(isset($arr_user['profile_image']) && $arr_user['profile_image'] != '' && file_exists($user_image_base_path.$arr_user['profile_image']))
                                        <img alt="Image" src="{{ $user_image_public_path.$arr_user['profile_image'] }}">
                                    @else
                                        <img alt="Image Not Found" src="{{ url('/').config('app.project.img_path.user_placeholder_image') }}">
                                    @endif
                                </div> </td>
                                    </tr> --}}
                                    {{-- <tr class="odd">
                                    ...
                                    <tr>
                                        <th style="width: 40%;">Voter Id</th>
                                        <td style="width: 60%;">{{ $arr_user['voter_id'] or 'NA'}}</td>
                                    </tr>
                                    <tr class="odd">
