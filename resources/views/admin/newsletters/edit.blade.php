		...
		<div class="col-md-12">
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<form action="{{$module_url_path}}/update/{{ base64_encode($arr_news_letter['id']) }}" id="frm_blogs_page" name="frm_blogs_page" class="form-horizontal cmxform" method="post" enctype="multipart/form-data">
						{{csrf_field()}}
						
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Title</label>
							<div class="col-sm-6">
								<input type="text" id="title" name="title"  data-rule-required="true" class="form-control" value="{{ $arr_news_letter['title'] or 'NA' }}" >
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" id="subject"  name="subject"  data-rule-required="true"  class="form-control " value="{{ $arr_news_letter['subject'] or 'NA' }}" >
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea  name="description" id="description" class="form-control" data-rule-required="true" rows="15" tabindex="1">{{ $arr_news_letter['news_description'] or 'NA' }} </textarea>
