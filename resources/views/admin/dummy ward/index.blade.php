            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ url('/') }}/admin/wards/create" class="btn btn-default btn-rounded show-tooltip" title="Add New Wards"><i class="fa fa-plus"></i></a>
                                ...
                                <table class="display table table-bordered dataTable" id="hidden-table-info" id="tbl_activitylog_listing">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Wards No
                                                <input type="text" name="ward_no" placeholder="Search" class="search-block-new-table form-control column_filter">
                                            </th>
                                            <th>village Number
                                                <input type="text" name="village_id" placeholder="Search" class="search-block-new-table form-control column_filter">
                                            ...
                                            <th>Wards Name
                                                <input type="text" name="ward_name" placeholder="Search" class="search-block-new-table form-control column_filter">
                                            </th>
                                            <th>Wards Address
                                                <input type="text" name="ward_address" placeholder="Search" class="search-block-new-table form-control column_filter"></th>
    ...
    var oTable = $('#hidden-table-info').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d['column_filter[village_id]']  = $("input[name='village_id']").val()
        ...
        columns: [
            ...
            {data : 'village_id',"orderable":false,"searchable":true,name:'village_id'},
