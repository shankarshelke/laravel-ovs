...
<div class="left-side-inner">
    ...
    <ul class="nav nav-pills nav-stacked custom-nav">
        @if(get_admin_access('dashboard','module_view'))
            <li class="@if(Request::segment(2) == 'dashboard') active @endif"><a class="loadPage" data-url="/<?= $admin_panel_slug;?>/dashboard"><i class="ti-home"></i> <span class="menu-label-span">{{ trans('sidebar.dashboard') }}</span></a>
            </li>
        @endif
         
        @if(get_admin_access('site_setting','module_view'))

            <li class="@if(Request::segment(2) == 'site_setting') active @endif"><a class="loadPage" data-url="/<?= $admin_panel_slug;?>/site_setting" ><i class="icon-settings"></i> <span class="menu-label-span">{{ trans('sidebar.site setting') }}</span></a>
            </li>
        @endif
        ...
        @if(get_admin_access('voters','module_view'))
            <li class="@if(Request::segment(2) == 'voters') active @endif"><a class="loadPage" data-url="/<?= $admin_panel_slug;?>/voters"><i class="ti-user"></i> <span class="menu-label-span">{{ trans('sidebar.voters') }}</span></a>
            </li>
        @endif
       {{--  @if(get_admin_access('voters','module_view'))
