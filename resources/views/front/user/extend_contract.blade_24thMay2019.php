                        ...
                        <div class="table-row">
                            <div class="table-cell">
                                ...
                                <div class="admin-content">
                                    ...
                                    <div class="admin-text">From : <span style="color: black;">{{isset($data['pickup_location'])? $data['pickup_location']:''}}</span></div>
                                </div>
                            ...
                            <div class="table-cell"> 
                                ...
                                @elseif(isset($data['extend_requests']) && $data['extend_requests'][
                                    ...
                                    <button class="extend-req" >Allowed</button>
                                        ...
                                        <button class="extend-req" data-toggle="modal" data-target="#myModal1" id="review_modal" data-id="{{$data['id']}}" onclick=" return ChkExetendPayment(this);">Pay</button>
                                    ...
                                    @elseif(isset($data['extend_requests']) && $data['extend_requests']['payment_status']=='REJECTED')
                                        <button class="extend-req" data-toggle="modal" data-target="#myModal1" id="review_modal" data-id="{{$data['id']}}" onclick=" return ChkExetendPayment(this);">Pay Again</button>
                                ...
                                @elseif( $data['is_signed'] != '1' || $data['payment_status'] !=  'APPROVED')
