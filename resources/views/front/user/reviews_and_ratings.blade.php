...
<section class="gray-bg-main-section">
    <div class="container">
        ...
        <div class="rating-review-box">
            <div class="rating-id">{{ $value['get_reservation']['reservation_id'] or 'N/A'}}</div>
            ...
            <div class="equipment-content-main review-ratings-content-main review-top-border">
                ...
                <div class="review-profile-image">
                    @if(isset($value['owner']['profile_image']) && $value['owner']['profile_image']!=null && file_exists($operator_profile_base_img_path.$value['owner']['profile_image']))
                    <img src="{{get_resized_image($value['owner']['profile_image'] ,$operator_profile_base_img_path,70,70)}}">
                    @else
                ...
                <div class="review-content-block">
                    <div class="review-send-head">
                     {{ $value['owner']['first_name'] or 'N/A' }} {{ $value['owner']['last_name'] or 'N/A'}}
                 </div>
