            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="button-quote request-button main-button1">
                        <div class="accept"><a href="{{ url('/').'/operator/view_contract/'.base64_encode($value["id"]) }}">View Contract</a></div>
                    </div>   
                </div>
            </div>
            @endforeach
...
<script type="text/javascript">
    ...
    $('#search').on("keypress", function(e) {
        if (e.keyCode == 13) {
            var search = $(this).val();
            window.location.href = "{{ url('/') }}/operator/cancelled_bookings?search="+search
        }
    });
    ...
    $('.reset-form').click(function(){
            $("#search").val('');
            window.location.href = "{{ url('/') }}/operator/cancelled_bookings";
        });
