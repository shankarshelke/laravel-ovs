...
?>
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <div class="main-quote request-quote-main booking-pending">
                        <a href="{{ url('/') }}/details/{{ base64_encode($value['get_aircraft_details']['id']) }}">
                            <div class="img-quote">
                                ...
                                <!-- <div class="text-quote">
                                    ...
                                    <div class="profile-text-quote">{{$value['get_user_details']['first_name'] or ''}} {{$value['get_user_details']['last_name'] or ''}}
                                    </div>
                                </div> --> 
                        ...
                        <div class="button-quote request-button main-button1">
                            <div class="accept"><a href="{{ url('/').'/operator/view_contract/'.base64_encode($value["id"]) }}">{{ trans('general.view_contract') }}</a></div>
                        </div>   
                    </div>
                </div>
                @endforeach   
    ...
    <script type="text/javascript">
        ...
        $('#search').on("keypress", function(e) {
            if (e.keyCode == 13) {
                var search = $(this).val();
                window.location.href = "{{ url('/') }}/operator/pending_bookings?search="+search
            }
        });
        ...
        $('.reset-form').click(function(){
            $("#search").val('');
            window.location.href = "{{ url('/') }}/operator/pending_bookings";
        });
    </script>
