...
$ACCESS_PWD='webwing_admin'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"wingdemo_voting",#required
'pwd'=>"voting@@30", #required
'db'=>"wingdemo_voting",  #optional, default DB
