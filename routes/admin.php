...
// ------------Before Login Routes----------------
$module_controller = "Admin\LangController@";
...
Route::group(array('prefix' => $web_admin_path,'middleware'=>'auth_admin'), function ()
{
	...
	Route::group(array('prefix' => 'voters'), function ()
	{
		...
		Route::get('/export_voters',					['as' =>$route_slug.'export_voters', 'uses' => $module_controller.'export_voters', 'middleware' => 'module_access_permission']);
		
		Route::get('/today_birthday',					['as' =>$route_slug.'today_birthday', 'uses' => $module_controller.'today_birthday', 'middleware' => 'module_access_permission']);
		...
		Route::get('/voter',		['as' =>$route_slug.'voter_create', 'uses' => $module_controller.'voter_create', 'middleware' => 'submodule_access_permission']);

		Route::get('/aadhar_voter',		['as' =>$route_slug.'aadhar_voter', 'uses' => $module_controller.'aadhar_voter', 'middleware' => 'submodule_access_permission']);

		Route::post('/store',		['as' =>$route_slug.'store', 'uses' => $module_controller.'store']);

		Route::post('/add_member',		['as' =>$route_slug.'add_member', 'uses' => $module_controller.'add_member']);

		Route::get('/load_member',		['as' =>$route_slug.'load_member', 'uses' => $module_controller.'load_member']);

		Route::get('/import',		['as' =>$route_slug.'import', 'uses' => $module_controller.'import']);

		Route::post('/import_file',		['as' =>$route_slug.'import_file', 'uses' => $module_controller.'import_file']);
    	...
    	Route::get('get_address',	 	['as'=>$route_slug.'get_address', 'uses' => $module_controller.'get_address']);

    	/*Route::post('send_newsletter',	 	['as'=>$route_slug.'send_newsletter', 'uses' => $module_controller.'send_newsletter']);*/

    	Route::any('send_newsletter',	 	['as'=>$route_slug.'send_newsletter', 'uses' => $module_controller.'send_newsletter']);

    	Route::any('send_birthday_msg',	 	['as'=>$route_slug.'send_birthday_msg', 'uses' => $module_controller.'send_birthday_msg']); 
	...
	/*
	Route::group(array('prefix' => 'aadhar'), function ()
	{
		$route_slug = 'admin_';

		$module_controller = "Admin\AadharController@";
		...
		Route::post('/add_aadhar',		['as' =>$route_slug.'add_aadhar', 'uses' => $module_controller.'add_aadhar']);
	...
	*/
	Route::group(array('prefix' => 'voting_card'), function ()
	{
		$route_slug = 'admin_';

		$module_controller = "Admin\VotingCardController@";
        ...
        Route::post('/voter_create', ['as' =>$route_slug.'store', 'uses' => $module_controller.'update_voting_card']);
	...
	Route::group(array('prefix' => 'wards'), function () 
   	{
		$route_slug = 'admin_';
		$module_controller = "Admin\WardController@";
		// dd('here');
		Route::get('/',       ['as' =>$route_slug.'create', 'uses' => $module_controller.'index']);
	...
	Route::group(array('prefix' => 'demo_booth'), function ()
	{
		$route_slug = 'admin_';

		$module_controller = "Admin\BoothsController@";
	...
	Route::group(array('prefix' => 'my_team'), function () 
	{
		...
		Route::get('/verify_subadmin/{id}/{cred}',['as' =>$route_slug.'verify_subadmin', 'uses' => $module_controller.'verify_subadmin']);
	...
	Route::group(array('prefix' => 'sms_template'), function () 
	{
		$route_slug = 'admin_';

		$module_controller = "Admin\SmsTemplateController@";		
		...
		Route::post('/send_sms_to_user',	  ['as' =>$route_slug.'send_sms_to_user', 'uses' => $module_controller.'send_sms_to_user']);
	...
	Route::group(array('prefix' => 'group'), function () 
	{
		...
		$module_controller = "Admin\GroupController@";		
	...
	Route::group(array('prefix' => 'cron_schedule'), function () 
	{
		$route_slug = 'admin_';

		$module_controller = "Admin\AddCronScheduleController@";		
	...
	{
	 	$route_slug = 'admin_';
      	$module_controller = "Admin\MoneyDistributionsController@";
	 	Route::get('/',				['as' =>$route_slug.'create', 'uses' => $module_controller.'index']);
		...
		Route::get('/unblock/{id?}',['as' =>$route_slug.'categories', 'uses' => $module_controller.'unblock']);
	 	...
	 	Route::any('get_villages',	 	['as'=>$route_slug.'get_villages', 'uses' => $module_controller.'get_villages']);
	 	Route::get('/create_voter',		['as' =>$route_slug.'create_voter', 'uses' => $module_controller.'create_voter', 'middleware' => 'submodule_access_permission']);

	 	Route::post('/stores',		['as' =>$route_slug.'stores', 'uses' => $module_controller.'stores']);
	...
	{
	 	$route_slug = 'admin_';
      	$module_controller = "Admin\VoterMoneyDistributionsController@";
	 	Route::get('/',				    ['as' =>$route_slug.'create', 'uses' => $module_controller.'index']);
