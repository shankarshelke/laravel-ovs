<?php
$time = time();
$url = '../uploads/editor/'.$time."_".$_FILES['upload']['name'];
...
//extensive suitability check before doing anything with the file...
    ...
    echo $url = $fdata[0]."uploads/editor/" . $time."_".$_FILES['upload']['name'];
      if(!$move)
      {
         $message = "Error moving uploaded file. Check the script is granted Read/Write/Modify permissions.";
      }
      $url = $fdata[0]."uploads/editor/" . $time."_".$_FILES['upload']['name'];
    }
